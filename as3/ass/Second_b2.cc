...
NS_LOG_COMPONENT_DEFINE ("Secong_b2ScriptExample");
...
main (int argc, char *argv[])
{
  ...
  Ptr<OutputStreamWrapper> stream = asciiTraceHelper.CreateFileStream ("Secong_b2.cwnd");
  ns3TcpSocket->TraceConnectWithoutContext ("CongestionWindow", MakeBoundCallback (&CwndChange, stream));

  PcapHelper pcapHelper;
  Ptr<PcapFileWrapper> file = pcapHelper.CreateFile ("Secong_b2.pcap", std::ios::out, PcapHelper::DLT_PPP);
  ...
  plotHelper.ConfigurePlot ("Secong_b2-packet-byte-count",
  ...
  fileHelper.ConfigureFile ("Secong_b2-packet-byte-count",
