...
main (int argc, char *argv[])
{
  ...
  TypeId tid0 = TypeId::LookupByName ("ns3::TcpNewReno");
  ...
  Ptr<OutputStreamWrapper> stream1 = asciiTraceHelper1.CreateFileStream ("Third_conf1_1.cwnd");
  ...
  Ptr<OutputStreamWrapper> stream2 = asciiTraceHelper2.CreateFileStream ("Third_conf1_2.cwnd");
  ...
  Ptr<OutputStreamWrapper> stream3 = asciiTraceHelper3.CreateFileStream ("Third_conf1_3.cwnd");
  ...
  plotHelper.ConfigurePlot ("Third_conf1_1-packet-byte-count",
  ...
  // for the output files generated.  The second, third, and fourth
  // arguments are, respectively, the plot title, x-axis, and y-axis labels
  plotHelper1.ConfigurePlot ("Third_conf1_2-packet-byte-count",
                            "Packet Byte Count vs. Time",
                            "Time (Seconds)",
                            "Packet Byte Count");
  ...
  // for the output files generated.  The second, third, and fourth
  // arguments are, respectively, the plot title, x-axis, and y-axis labels
  plotHelper2.ConfigurePlot ("Third_conf1_3-packet-byte-count",
                            "Packet Byte Count vs. Time",
                            "Time (Seconds)",
                            "Packet Byte Count");
