...
NS_LOG_COMPONENT_DEFINE ("First_3ScriptExample");
...
main (int argc, char *argv[])
{
  ...
  Ptr<OutputStreamWrapper> stream = asciiTraceHelper.CreateFileStream ("First_3.cwnd");
  ns3TcpSocket->TraceConnectWithoutContext ("CongestionWindow", MakeBoundCallback (&CwndChange, stream));

  PcapHelper pcapHelper;
  Ptr<PcapFileWrapper> file = pcapHelper.CreateFile ("First_3.pcap", std::ios::out, PcapHelper::DLT_PPP);
  ...
  plotHelper.ConfigurePlot ("First_3-packet-byte-count",
  ...
  fileHelper.ConfigureFile ("First_3-packet-byte-count",
