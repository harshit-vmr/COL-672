...
NS_LOG_COMPONENT_DEFINE ("First_2ScriptExample");
...
main (int argc, char *argv[])
{
  ...
  Ptr<OutputStreamWrapper> stream = asciiTraceHelper.CreateFileStream ("First_2.cwnd");
  ns3TcpSocket->TraceConnectWithoutContext ("CongestionWindow", MakeBoundCallback (&CwndChange, stream));

  PcapHelper pcapHelper;
  Ptr<PcapFileWrapper> file = pcapHelper.CreateFile ("First_2.pcap", std::ios::out, PcapHelper::DLT_PPP);
  ...
  plotHelper.ConfigurePlot ("First_2-packet-byte-count",
  ...
  fileHelper.ConfigureFile ("First_2-packet-byte-count",
